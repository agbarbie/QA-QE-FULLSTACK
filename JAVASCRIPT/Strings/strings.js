...
function is_String(input){
    ...
    console.log(_capitalize('js string exercises')); // "Js string exercises"
    ...
    //14. Insert String
    function _insert(str,insertStr,position){
        return str.slice(0,position)+ insertStr + str.slice(position);
    }
    console.log(_insert('We are doing some exercises.', 'JavaScript ', 18));// "We are doing some JavaScript exercises."
    ...
    //18. Chop Substring Occurrences
    function _count(str,subStr){
        let regex = new RegExp(subStr,'gi');
        return (str.match(regex));
    }
    console.log(_count("The quick brown fox jumps over the lazy dog", 'the'));// Output: 2
